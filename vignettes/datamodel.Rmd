...
When used as a parameter in `voxanalysis` functions, this data set is called `df_output_exportable`. You can also [download this .csv file](assets/df_output_exportable_example.csv) for example.
