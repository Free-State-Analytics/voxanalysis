...
A user may also upload any data set, provided it follows the data model [guidelines](https://free-state-analytics.github.io/voxanalysis/articles/datamodel.html). You can also [download this .csv file](assets/df_output_exportable_example.csv) for example.
